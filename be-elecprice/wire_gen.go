...
func InitApp() *App {
	...
	jnbClient := ioc.InitJnbClient(client2, serverConf, logger)
	elecpriceService := service.NewElecpriceService(elecpriceDAO, logger, elecPriceCache, client2, jnbClient)
